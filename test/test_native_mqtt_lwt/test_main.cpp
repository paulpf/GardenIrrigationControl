...
void test_lwt_topic_buffer_no_overflow_long_name(void)
{
  ...
  char lwtTopic[96];
  const char *longDeviceName = "GardenIrrigationControlZone1-Sensor2-Module3-Unit4-Debug5-System6-Test7";
...
{
  // Without LWT:
  // - System reliability depends on device staying alive long enough to publish "offline"
