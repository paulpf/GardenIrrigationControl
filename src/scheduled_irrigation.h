...
struct IrrigationSchedule
{
    ...
    IrrigationSchedule() : enabled(false), hour(6), minute(0), durationMinutes(5), daysOfWeek(0x3E) {} // Default: Mon-Fri 6:00 AM, 5 min
};
...
private:
    ...
    bool isScheduleTimeMatch(const IrrigationSchedule& schedule, unsigned long currentTime) const;
