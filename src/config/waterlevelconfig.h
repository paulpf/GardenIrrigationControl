...
struct WaterLevelConfig
{
  ...
  float criticalOverflowBufferLiters = WATER_LEVEL_CRITICAL_OVERFLOW_BUFFER_LITERS;
  float criticalOverflowReleaseLiters = WATER_LEVEL_CRITICAL_OVERFLOW_RELEASE_LITERS;
